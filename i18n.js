  ...
  var TRANSLATIONS = {
    de: {
      ...
      ref_page: {
        ...
        glance1_lbl: 'Branche', glance1_val: 'Stahl- und Metallbau',
        glance2_lbl: 'Team', glance2_val: '14 Mitarbeitende',
        glance3_lbl: 'Projektdauer', glance3_val: '18 Monate',
        glance4_lbl: 'Ergebnis', glance4_val: '+50 % Jahresumsatz',
        s1_label: '01 — AUSGANGSLAGE',
        s1_h: 'Volle Auftragsbücher, stehender Umsatz.',
        s1_p: 'Metallbau Hofer, seit 1987 in Familienhand, hatte über Jahre einen stabilen Kundenstamm aufgebaut — und trotzdem stagnierte der Umsatz bei rund 500.000 € im Jahr, obwohl die Auftragsbücher voll waren. Aufträge kamen herein, blieben aber in informellen Abstimmungsschleifen hängen. Wer wofür zuständig war, wusste oft nur der Inhaber selbst.',
        s1_li1: 'Angebote wurden manuell erstellt, ohne einheitliche Vorlage oder festen Ablauf',
        s1_li2: 'Rückfragen zu laufenden Aufträgen liefen fast ausschließlich über den Inhaber persönlich',
        s1_li3: 'Material wurde oft erst kurzfristig bestellt — mit Wartezeiten in der Werkstatt als Folge',
        s1_li4: 'Neue Mitarbeitende brauchten Monate, um die informellen Abläufe zu durchschauen',
        s2_label: '02 — VORGEHEN',
        s2_h: 'Diagnose vor Lösung — wie überall bei uns.',
        s2_p: 'Drei Phasen, angewendet auf einen konkreten Fall.',
        phase1_h: 'Diagnose',
        phase1_p: 'Sechs Wochen vor Ort: Gespräche mit allen 14 Mitarbeitenden, Begehung der Werkstatt, Nachzeichnen des kompletten Auftragsprozesses vom ersten Kundenkontakt bis zur Montage. Ergebnis: Drei von fünf Verzögerungen entstanden nicht in der Werkstatt, sondern in der Kommunikation davor.',
        phase2_h: 'Neugestaltung',
        phase2_p: 'Aus der Diagnose entstand ein neues Rollenmodell: eine feste Zuständigkeit für Angebotserstellung mit einheitlicher Vorlage, eine eigene Rolle für Materialdisposition, ein wöchentliches Kurz-Meeting zur Terminplanung. Zuerst Klarheit über Verantwortlichkeiten — nicht neue Software.',
        phase3_h: 'Umsetzung',
        phase3_p: 'Vier Monate Begleitung vor Ort: wöchentliche Check-ins, Einarbeitung der beiden neuen Rollen, laufende Anpassung, wo die erste Version nicht funktionierte — bis der neue Ablauf im Alltag trug.',
        s2b_label: '03 — HERAUSFORDERUNGEN',
        s2b_h: 'Nicht alles lief beim ersten Versuch.',
        ch1: 'Langjährige Mitarbeitende begegneten den neuen Zuständigkeiten anfangs mit Skepsis — Veränderung nach Jahrzehnten eingespielter Abläufe braucht Zeit.',
        ch2: 'Die erste Version der Angebotsvorlage war zu kleinteilig und wurde nach Rückmeldung aus der Praxis vereinfacht.',
        ch3: 'Mitten in der Hochsaison ein neues Meeting einzuführen, kostete zunächst mehr Zeit, als es sparte — bis sich der Rhythmus eingespielt hatte.',
        s3_label: '04 — ERGEBNIS',
        s3_h: 'Was am Ende zählt.',
        ba_th1: 'Kennzahl', ba_th2: 'Vorher', ba_th3: 'Nachher',
        ba_row1_k: 'Jahresumsatz',
        ba_row2_k: 'Durchlaufzeit Anfrage → Angebot', ba_row2_before: '≈ 9 Tage', ba_row2_after: '≈ 5,5 Tage',
        ba_row3_k: 'Zuständigkeit bei Rückfragen', ba_row3_before: 'nur der Inhaber', ba_row3_after: 'klares Rollenmodell',
        ...
        quote2: '„Früher haben wir improvisiert, wenn Material fehlte. Heute wissen wir schon Tage vorher, was ankommt — das nimmt eine Menge Druck raus.“',
        quote2_cite: 'Werkstattleitung, Metallbau Hofer',
    ...
    en: {
      ...
      ref_page: {
        ...
        glance1_lbl: 'Industry', glance1_val: 'Steel & metal fabrication',
        glance2_lbl: 'Team', glance2_val: '14 employees',
        glance3_lbl: 'Project duration', glance3_val: '18 months',
        glance4_lbl: 'Result', glance4_val: '+50% annual revenue',
        s1_label: '01 — STARTING POINT',
        s1_h: 'Full order books, flat revenue.',
        s1_p: "Metallbau Hofer, family-owned since 1987, had built a stable customer base over the years — yet revenue stalled at around €500,000 a year despite a full order book. Orders came in, but got stuck in informal back-and-forth. Who was responsible for what was often only clear to the owner himself.",
        s1_li1: 'Quotes were put together manually, with no shared template or fixed process',
        s1_li2: 'Questions about ongoing orders went almost exclusively through the owner personally',
        s1_li3: 'Materials were often ordered at the last minute, causing wait times in the workshop',
        s1_li4: 'New employees needed months to figure out the informal ways of working',
        s2_label: '02 — APPROACH',
        s2_h: 'Diagnosis before solution — as always.',
        s2_p: 'Three phases, applied to one real case.',
        phase1_h: 'Diagnosis',
        phase1_p: 'Six weeks on site: conversations with all 14 employees, walking the workshop floor, mapping the entire order process from first customer contact to installation. Result: three out of five delays happened not in the workshop, but in the communication beforehand.',
        phase2_h: 'Redesign',
        phase2_p: 'The diagnosis produced a new role model: a dedicated owner for quoting with a shared template, a separate role for material planning, a short weekly scheduling meeting. Clarity on responsibilities first — not new software.',
        phase3_h: 'Implementation',
        phase3_p: 'Four months of on-site support: weekly check-ins, onboarding the two new roles, ongoing adjustments where the first version fell short — until the new workflow held up in daily practice.',
        s2b_label: '03 — CHALLENGES',
        s2b_h: "Not everything worked on the first try.",
        ch1: 'Long-tenured staff initially met the new responsibilities with skepticism — changing habits built over decades takes time.',
        ch2: 'The first version of the quote template was too fussy and was simplified after feedback from daily use.',
        ch3: 'Introducing a new meeting in the middle of peak season cost more time than it saved at first — until the rhythm settled in.',
        s3_label: '04 — RESULT',
        s3_h: 'What matters in the end.',
        ba_th1: 'Metric', ba_th2: 'Before', ba_th3: 'After',
        ba_row1_k: 'Annual revenue',
        ba_row2_k: 'Lead time, inquiry → quote', ba_row2_before: '≈ 9 days', ba_row2_after: '≈ 5.5 days',
        ba_row3_k: 'Who handles questions', ba_row3_before: 'owner only', ba_row3_after: 'clear role model',
        ...
        quote2: '"We used to improvise whenever material was missing. Now we know days in advance what\'s arriving — that takes a lot of pressure off."',
        quote2_cite: 'Workshop lead, Metallbau Hofer',
